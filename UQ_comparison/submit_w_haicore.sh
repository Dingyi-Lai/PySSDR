...
export READ_PATH=/home/scc/pa6512/PySSDR/data_generation/output  # <-- New!
...
python training_w_unstructured.py

# Copy results from TMPDIR to home after job finishes
cp -r $TMPDIR/outputs_w_unstructured ~/PySSDR/UQ_comparison